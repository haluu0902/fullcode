var config = {
    bet: { label: 'Bet', value: 0.0000001, type: 'number' },
    multiBetting: { label: "Multi: ", value: 1.35, type: "number" },
    payout: { label: 'Payout', value: 10, type: 'number' },
    loseStreakToChange: { label: "Max lose streak to Change: ", value: 56, type: "number" },
    payoutChange: { label: "Payout change after 1 lose ", value: 4.5, type: "number" },
