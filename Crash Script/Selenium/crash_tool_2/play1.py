                    ...
                    if(lastPayout != payout):
                        ...
                        with open("./data/history_dice.txt", "a+") as hd:
                            ...
                            if(profit - bet <= stopLost*1.3):
                                ...
                                break
                            if(timeRun != 1):
                                ActionChains(driver).click(inputC[0]).key_down(Keys.CONTROL).send_keys("a").key_up(Keys.CONTROL).send_keys(str(bet)).perform()
                                time.sleep(3)
                                try:
                                ...
                                if(check2):
                                    ...
                                    while True:    
                                        ...
                                        if(payout2 != lastPayout):
                                            if(payout2 *lowOrHigh > 2 * lowOrHigh):
                                                if(lowOrHigh == -1)
                                                    winP = bet*0.96
                                                else:
                                                    winP = bet
