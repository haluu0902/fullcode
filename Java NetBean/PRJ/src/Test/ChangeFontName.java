 ...
 * @author ANHDUC
 */
public class ChangeFontName extends javax.swing.JFrame {

    /**
     * Creates new form DemoFontChange
     */
    public ChangeFontName() {
        initComponents();
        initFont();
        initTimer();
    }
    ...
    private void initTimer() {
        t = new Timer(500, (evt) -> {
            if (canRun) {
                lblDisplay.setFont(new Font(fn[index++], fStyle, fSize));
                length = length>fn.length?fn.length:length;
                index = index%length;
            }
        }); 
        t.start();
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        index = 0;
        canRun = false;
        lblDisplay.setFont(new Font(fn[0], fStyle, fSize));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeFontName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeFontName().setVisible(true);
            }
        });
    }
