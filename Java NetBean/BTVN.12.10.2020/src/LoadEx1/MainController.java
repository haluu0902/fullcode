...
public class MainController {
    ...
    public MainController(LoadToTableEx1 f1) {
        this.f1 = f1;
    }
    ...
    private void xulySearch() {
        f1.getBtnSearch().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (f1.getChkID().isSelected()) {
                    ar.add(0);
                }
                if (f1.getChkFullName().isSelected()) {
                    ar.add(1);
                }
                if (f1.getChkGender().isSelected()) {
                    ar.add(2);
                }
                if (f1.getChkDepartName().isSelected()) {
                    ar.add(0);
                }
                if (f1.getChkGPA().isSelected()) {
                    ar.add(0);
                }
                if (f1.getChkAddress().isSelected()) {
                    ar.add(0);
                }
    ...
    public static void main(String[] args) {
        new MainController(new LoadToTableEx1()).control();
    }
}
