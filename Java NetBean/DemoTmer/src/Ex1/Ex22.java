 ...
 * @author PH
 */
public class Ex22 extends javax.swing.JFrame {
...
//                s = MoveWord(s, xyz.isSelected());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ex22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
